...
function ( cat_1, alpha_1, beta_1 )
    ...
    deduped_24_1 = @NTupleGAP( 3, BigInt( 0 ), CapJitTypedExpression( [  ], function (  )
              return @rec(
                  filter = IsList,
                  element_type = @rec(
                      filter = IsInt ) );
    ...
    deduped_19_1 = SKELETAL_FIN_SETS_ExplicitCoequalizer_primitive_input( deduped_27_1, [ @NTupleGAP( 3, deduped_35_1, List( (0):(deduped_35_1 - 1), function ( i_2 )
                    return hoisted_1_1[1 + i_2];
                end ), deduped_27_1 ), @NTupleGAP( 3, deduped_36_1, List( (0):(deduped_36_1 - 1), function ( i_2 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_39_1, deduped_40_1, VertexLabeledGraph, @NTupleGAP( 4, List( (0):(BigInt( Length( deduped_19_1 ) ) - 1), function ( y_2 )
                if (@not y_2 in deduped_5_1)
                    return "neutral";
                else
                    return hoisted_6_1[SafePosition( deduped_5_1, y_2 )];
